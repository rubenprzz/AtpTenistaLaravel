    ...
    <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 mt-20">
        ...
        <form action="{{ route('torneos.addParticipante', $torneo->id) }}" method="POST">
            ...
            <div class="flex justify-end mt-6">
                <button type="submit" class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Añadir Participante</button>
            </div>
        </form>
    </section>
@endsection
